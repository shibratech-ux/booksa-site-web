      ...
      <span aria-hidden="true" className="relative block h-[54%] w-[66%] max-w-32">
        {previews.map((src, index) => (
          <img
            ...
            loading="lazy"
            decoding="async"
            className={`absolute h-[76%] w-[60%] rounded-xl border-[3px] border-white object-cover shadow-[0_2px_5px_rgba(0,0,0,0.22)] transition-transform duration-200 motion-reduce:transition-none ${
              index === 0
