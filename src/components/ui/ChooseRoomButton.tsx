...
export function ChooseRoomButton({
  ...
  return (
    <button
      type="button"
      className={cn(
        'min-h-12 cursor-pointer rounded-button bg-[var(--color-primary-500)] px-6 py-3 text-base font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[var(--color-primary-600)]',
