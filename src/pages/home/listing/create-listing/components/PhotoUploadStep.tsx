  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[704px]">
        ...
        {files.length === 0 ? (
          <div className="mt-7 flex min-h-[308px] items-center justify-center rounded-card border border-dashed border-[var(--color-text-secondary)] bg-[var(--color-surface-muted)]/35 sm:mt-12 sm:min-h-[473px]">
            <div className="flex flex-col items-center px-6 text-center">
              ...
              <button
                ...
                className="mt-8 inline-flex h-11 items-center justify-center rounded-button bg-[var(--color-surface)] px-5 text-sm font-semibold shadow-[var(--shadow-xs)] transition hover:bg-[var(--color-surface-muted)]"
              >
                Add photos
              </button>
            </div>
          ...
          <div className="mt-10 rounded-card p-3 sm:p-4">
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
              {previews.map(({ file, key, url }, index) => (
                <figure
                  key={key}
                  className={`group flex flex-col overflow-hidden rounded-photo border border-[var(--color-border)] bg-[var(--color-surface-muted)] ${
                ...
                >
                  ...
                  <figcaption className="flex min-h-11 items-center justify-between gap-2 border-t border-[var(--color-border)] bg-[var(--color-surface)] px-3">
                    ...
                    <button
                      ...
                      className="inline-flex h-8 max-sm:h-11 max-sm:w-11 w-8 shrink-0 items-center justify-center rounded-full transition hover:bg-[var(--color-surface-muted)]"
                    >
              ...
              <button
                type="button"
                onClick={() => setIsUploadDialogOpen(true)}
                className="flex aspect-square flex-col items-center justify-center rounded-card border border-dashed border-[var(--color-text-secondary)] bg-[var(--color-surface-muted)]/35 text-sm font-semibold transition hover:border-[var(--color-text-primary)]"
              >
