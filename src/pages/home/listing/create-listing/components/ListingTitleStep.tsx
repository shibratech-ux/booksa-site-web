    ...
    >
      <div className="mx-auto flex min-h-full w-full max-w-[640px] flex-col justify-start py-2 sm:justify-center sm:py-6">
        ...
        <textarea
          ...
          className="mt-6 min-h-[150px] w-full resize-none rounded-[var(--radius-md)] border border-[var(--color-text-secondary)] bg-[var(--color-surface)] p-4 text-lg font-medium leading-relaxed text-[var(--color-text-primary)] outline-none transition placeholder:text-[var(--color-text-secondary)] focus:border-2 focus:border-[var(--color-text-primary)] sm:mt-8 sm:min-h-[186px] sm:p-5 sm:text-xl"
        />
        <p
