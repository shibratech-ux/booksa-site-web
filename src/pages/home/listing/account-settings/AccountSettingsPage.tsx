  ...
  const renderMobileSettingRow = (item: MobileSettingsItem) => {
    ...
    return (
      <button
        ...
        className="flex min-h-[47.3px] w-full items-center gap-4 text-left text-sm text-slate-800"
      >
        <Icon className="h-5 w-5 shrink-0 stroke-[1.6]" aria-hidden="true" />
        <span className="flex-1">{item.label}</span>
        {item.badge ? (
          <span className="rounded-sm bg-pink-50 px-2 py-1 text-xs font-medium text-pink-600">
            {item.badge}
          </span>
        ) : null}
  ...
  return (
    <main className="min-h-screen bg-[var(--color-surface)] text-[var(--color-text-primary)]">
      <header className="hidden border-b border-[var(--color-border)] bg-[var(--color-surface)] lg:block">
        <div className="mx-auto flex min-h-20 max-w-[1280px] items-center justify-between px-5 sm:px-8 lg:px-16">
      ...
      >
        <div className="mx-auto max-w-[429px]">
          ...
          {!isMobileSectionOpen ? (
            <>
              <h1 className="mt-4 px-2 text-2xl font-semibold tracking-[-0.035em]">Account settings</h1>
      ...
      <div
        className={`mx-auto max-w-[1280px] lg:grid lg:grid-cols-[280px_minmax(0,1fr)] lg:[&>aside]:block ${
      ...
      >
        ...
        <motion.section
          ...
          className="bg-[var(--color-surface)] px-5 py-8 sm:px-10 lg:px-10 lg:py-10 xl:px-12"
        >
          ...
          <div className="mx-auto max-w-[836px]">
            <h2 className="text-[28px] font-semibold tracking-[-0.035em] sm:text-[28px]">{t('personalInformation')}</h2>
